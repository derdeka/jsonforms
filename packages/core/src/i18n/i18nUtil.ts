...
export const getI18nKeyPrefixBySchema = (schema: i18nJsonSchema | undefined, uischema: UISchemaElement | undefined): string | undefined => {
 ...
 */
export const transformPathToI18nPrefix = (path: string) => path?.split('.').filter(segment => !/^\d+$/.test(segment)).join('.') || 'root';

export const getI18nKeyPrefix = (schema: i18nJsonSchema | undefined, uischema: UISchemaElement | undefined, path: string | undefined): string | undefined => {
  return getI18nKeyPrefixBySchema(schema, uischema) ?? transformPathToI18nPrefix(path);
};

export const getI18nKey = (schema: i18nJsonSchema | undefined, uischema: UISchemaElement | undefined, path: string | undefined, key: string): string | undefined => {
 ...
 */
export const getCombinedErrorMessage = (errors: ErrorObject[], et: ErrorTranslator, t: Translator, schema?: i18nJsonSchema, uischema?: UISchemaElement, path?: string) => {
